...
if (!interactive()) {
  ...
  yaml_file <- # <<------------------------------------------------- CUSTOMIZE!
#for grassland run perennial grass cover in CHCU and PEFO and WUPA with kitchen sink covariates, and then individual spp. for each. BOUGRA + HILJAM + SPOROB

    
    #species presence absence
    #'assets/uplands-config/SCPN-CHCU-PEFO-WUPA/GRASS/annuals-forb-pa.yml'
    
    
    #richness
    #"assets/uplands-config/SCPN-PARK/PEFO_C/Quadrich.yml"
    
    
    #multipark analyses
    "assets/uplands-config/SCPN-CHCU-PEFO-WUPA/GRASS/GRASS-grass-spp-cc.yml" #works
...
#this is just code to compile model summaries into a single file for easy comparison 
  source('model-api/src/wrangle.r')
#grass wide
get_mod_summary_files('./assets/uplands-output/SCPN-CHCU-PEFO-WUPA/GRASS/GRASS-grass-spp-cc/HILJAM')
